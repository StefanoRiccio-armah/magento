<?php
namespace MagestyApps\WebImages\Model\Image\Adapter\Gd2;

/**
 * Interceptor class for @see \MagestyApps\WebImages\Model\Image\Adapter\Gd2
 */
class Interceptor extends \MagestyApps\WebImages\Model\Image\Adapter\Gd2 implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Filesystem $filesystem, \Psr\Log\LoggerInterface $logger, \MagestyApps\WebImages\Helper\ImageHelper $helper, array $data = [])
    {
        $this->___init();
        parent::__construct($filesystem, $logger, $helper, $data);
    }
