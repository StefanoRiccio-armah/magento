...
class ProductExtension extends \Magento\Framework\Api\AbstractSimpleObject implements ProductExtensionInterface
{
     ...
     * @return int[]|null
     */
    public function getKlParentIds()
    {
        return $this->_get('kl_parent_ids');
    }

    /**
     * @param int[] $klParentIds
     * @return $this
     */
    public function setKlParentIds($klParentIds)
    {
        $this->setData('kl_parent_ids', $klParentIds);
        return $this;
    }
}
