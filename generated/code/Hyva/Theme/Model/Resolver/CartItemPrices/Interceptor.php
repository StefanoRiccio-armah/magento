...
class Interceptor extends \Hyva\Theme\Model\Resolver\CartItemPrices implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\QuoteGraphQl\Model\Cart\TotalsCollector $totalsCollector, \Magento\QuoteGraphQl\Model\GetDiscounts $getDiscounts)
    {
        $this->___init();
        parent::__construct($totalsCollector, $getDiscounts);
    }
